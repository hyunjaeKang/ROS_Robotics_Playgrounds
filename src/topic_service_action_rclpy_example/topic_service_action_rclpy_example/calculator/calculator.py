...
class Calculator(Node):
    ...
    def get_arithmetic_argument(self, msg):
        ...
        self.get_logger().info(f'Timestamp of the message {msg.stamp}')
        self.get_logger().info(f'Subscribed argument a : {self.argument_a}')
        self.get_logger().info(f'Subscribed argument b : {self.argument_b}')
    ...
    def execute_checker(self, goal_handle):
        self.get_logger().info('Execute arithmetic_check action')
